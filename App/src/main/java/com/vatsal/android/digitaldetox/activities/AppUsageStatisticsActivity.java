            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    ...
                    case R.id.about_us:
                        ...
                        break;
                    case R.id.stepcouter:
                        Toast.makeText(AppUsageStatisticsActivity.this, "Step Counter",Toast.LENGTH_SHORT).show();
                        Intent myIntentt = new Intent(AppUsageStatisticsActivity.this, stepcounter.class);
                        AppUsageStatisticsActivity.this.startActivity(myIntentt);
                        break;
                    case R.id.stopwatchlogo:
                        Toast.makeText(AppUsageStatisticsActivity.this, "Sleep Tracker",Toast.LENGTH_SHORT).show();
                        Intent myIntenttt = new Intent(AppUsageStatisticsActivity.this, stopwatch.class);
                        AppUsageStatisticsActivity.this.startActivity(myIntenttt);
                        break;
                }
